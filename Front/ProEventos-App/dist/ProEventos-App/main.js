...
module.exports = __webpack_require__(/*! C:\Meus Projetos\ProEventos\Front\ProEventos-App\src\main.ts */"zUnb");
...
class EventosComponent {
    ...
    getEventos() {
        this.http.get(`https://localhost:44312/api/Eventos`).subscribe(response => this.eventos = response, error => console.log(error));
    }
}
